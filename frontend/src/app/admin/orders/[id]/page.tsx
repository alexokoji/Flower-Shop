  ...
  if (isError || !order) {
    return (
      <div className="space-y-4">
        <Link href="/admin/orders" className="inline-flex items-center text-sm hover:text-accent">
    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <h1 className="display text-display-sm lg:text-4xl mt-2">{order.order_number}</h1>
      ...
      <div className="grid lg:grid-cols-[1fr_320px] gap-6">
        <section className="rounded-2xl border border-border bg-card shadow-soft p-6 lg:p-8 space-y-4">
          <h2 className="display text-lg">Items</h2>
        ...
        <aside className="space-y-6">
          ...
          <section className="rounded-2xl border border-border bg-card shadow-soft p-5 space-y-2 text-sm">
