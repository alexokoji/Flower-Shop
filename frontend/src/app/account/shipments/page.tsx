  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <h2 className="display-serif text-2xl">Shipments</h2>
      ...
      {isLoading ? (
        ...
        <div className="surface-luxe p-12 text-center">
          <Truck className="size-8 mx-auto text-roseGold" />
          <p className="display-serif text-2xl mt-4">No shipments yet</p>
            ...
            {filtered.map((s) => (
              <li key={s.id}>
                <Link
                  ...
                  className="surface-luxe p-5 block hover:border-roseGold/50 transition-colors"
                >
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex flex-col items-start gap-1.5">
                      ...
                      {s.payment_status !== "paid" && (
                        <span className="text-[10px] uppercase tracking-widest px-2.5 py-1 rounded-full bg-amber-100 text-amber-800">
                          Payment due
                        </span>
                      )}
                    </div>
