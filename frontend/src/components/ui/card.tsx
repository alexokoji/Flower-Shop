...
/**
 * Card — the workhorse surface. `interactive` adds the lift-on-hover used for
 * anything clickable; `flat` drops the shadow for cards sitting inside a well.
 */
...
>(({ className, ...props }, ref) => (
  <h3 ref={ref} className={cn("display text-lg leading-tight", className)} {...props} />
));
